...
$$
\frac{d}{dx} (fg) = f \left( \frac{\mathrm{d} g}{\mathrm{d} x}  \right) + g \left( \frac{\mathrm{d} f}{\mathrm{d} x} \right)
$$

Integrating both sides, and invoking the fundamental theorem,

$$
\int_a ^b \frac{d}{dx} (fg) \mathrm{d} x = \left. fg \right| ^b _a = \int _a ^b  f \left( \frac{\mathrm{d} g}{\mathrm{d} x}  \right) \mathrm{d} x + \int_a ^b g \left( \frac{\mathrm{d} f}{\mathrm{d} x} \right) \mathrm{d} x
$$
