...
$$
\nabla \times  \vec{B} = \mu_0 \vec{J} + \mu_0 \epsilon_0 \pdv{\vec{E}}{t} \tag{7.37}
$$
...
$$
\vec{J}_d = \epsilon_0 \pdv{\vec{E}}{t} \tag{7.38}
$$
...
$$
\oint \vec{B} \cdot \mathrm{d} \vec{l} = \mu_0 I_{enc} + \mu_0 \epsilon_0 \int \left( \pdv{\vec{E}}{t} \right) \cdot \mathrm{d} \vec{a} \tag{7.39}
$$
...
$$
\vec{F} q (\vec{E} + \vec{v} \times \vec{B}) \tag{7.41}
$$
...
$$
\nabla \cdot  \vec{J} = - \frac{\partial \rho}{\partial t} \tag{7.42}
$$
...
$$
\nabla \cdot  \vec{J}_m = - \frac{\partial \rho_m}{\partial t} \quad \nabla \cdot  \vec{J}_e = - \frac{\partial \rho_e}{\partial t} \tag{7.45}
$$
...
$$
\nabla \cdot  \vec{D} = \rho_f \tag{7.52}
$$

where, as in the static case

$$
\vec{D} = \epsilon_0 \vec{E} + \vec{P} \tag{7.53}
$$
...
$$
\nabla \times  \vec{H} = \vec{J}_f + \pdv{\vec{D}}{t} \tag{7.54}
$$

where, as before

$$
\vec{H} \equiv \frac{1}{\mu_0} \vec{B} - \vec{M} \tag{7.55}
$$
...
$$
\vec{P} = \epsilon_0 \chi_e \vec{E} \qquad \text{ and } \qquad \vec{M} = \chi_m \vec{H} \tag{7.57}
$$

so

$$
\vec{D} = \epsilon \vec{E} \qquad \text{ and } \qquad \vec{H} = \frac{1}{\mu} \vec{B} \tag{7.58}
$$
...
$$
\vec{J}_d \equiv \pdv{\vec{D}}{t} \tag{7.59}
$$
...
$$
\vec{E}_1 ^\parallel - \vec{E}_2 ^\parallel = 0 \tag{7.62}
$$
...
$$
\vec{H}_1 ^\parallel - \vec{H}_2 ^\parallel = \vec{K}_f \times \hat n \tag{7.63}
$$
