...
$$
\vec{A} \times \vec{B} = AB \sin(\theta) \hat{n} \tag{1.4}
$$
...
$$
(\vec{B} \times \vec{A}) = - (\vec{A} \times \vec{B}) \tag{1.6}
$$

![Figure 1.7](../img/1.7.png)
...
$$
\vec{A} \cdot(\vec{B} \times \vec{C}) = \vec{B} \cdot (\vec{C} \times \vec{A}) = \vec{C} \cdot (\vec{A} \times \vec{B}) \tag{1.15}
$$
...
$$
\vec{A} \times (\vec{B} \times \vec{C}) = \vec{B}(\vec{A} \cdot \vec{C}) - \vec{C} (\vec{A} \cdot \vec{B}) \tag{1.17}
$$
...
$$
\vec{A} \times [\vec{B} \times (\vec{C} \times \vec{D})] = \vec{B}[ \vec{A} \cdot (\vec{C} \times \vec{D})] - (\vec{A} \cdot \vec{B})(\vec{C} \times \vec{D}) \tag{1.18}
$$
...
$$
\vec{r} \equiv x \hat{x} + y \hat{y} + z \hat{z} \tag{1.19}
$$
...
$$
\hat{r} = \frac{\vec{r}}{r}  = \frac{x \hat{x} + y \hat{y} + z \hat{z}}{ \sqrt{x^2 + y^2 + z^2}} \tag{1.21}
$$
...
$$
\mathrm{d}{\vec{l}} = \mathrm{d}{x} \hat{x} + \mathrm{d}{y} \hat{y} + \mathrm{d}{z} \hat{z} \tag{1.22}
$$
...
$$
\vec{\Delta r } \equiv \vec{r} - \vec{r'} \tag{1.23}
$$

Its magnitude is

$$
|\Delta r | = | \hat{r} - \hat{r'} | \tag{1.24}
$$
...
$$
\Delta r  = (x - x') \hat{x} + (y-y') \hat{y} + (z-z') \hat{z} \tag{1.26}
$$


$$
|\Delta r | = \sqrt{(x - x')^2 + (y-y')^2 + (z-z')^2  } \tag{1.27}
$$
...
$$
\overline{A_i} = \sum_{j=1}^3 R_{ij} A_j \tag{1.31}
$$
